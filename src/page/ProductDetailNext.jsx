  ...
  return (
    <div className=" text-white rounded">
      ...
      <ul className="pl-3 text-black ">
        ...
        /><li className="text-[6px]" key={index}>{item}</li>
          </p>
        ))}
      </ul>
    </div>
  ...
  return (
    <div className="bg-green-100 h-screen grid gap-y-1 ">
      <div className="top row-span-6 grid gap-1 grid-cols-5 grid-rows-4">
        ...
        <SpecificationItem  title="Dimming" items={["1-10 volt", "2.4G", "24V/6", "Dali", "Zigbee", "Mash"]} />
        </div>
        <div className="one bg-[#8ac249]">
        <SpecificationItem title="CCT" items={["2700K", "3000K", "4000K", "5000K", "6500K"]} />
        </div>
        <div className="one bg-[#8ac249]">
        <SpecificationItem title="CRI" items={[" >80", " >90", " >92", " >95", " >97"]} />
        </div>
        <div className="one bg-[#8ac249]">

          <SpecificationItem title="Lumen/UGI" items={["80-120LM/w", "Henycomb", "Lence"]} />
        </div>
        <div className="one bg-[#8ac249]">
          <SpecificationItem title="Beam Angle" items={["8°", "16°", "24°", "36°", "48°"]} />

        </div>
        <div className="one bg-[#8ac249]">
          <SpecificationItem title="Reflector Color" items={["White", "Black", "Chrome", "Rose Gold", "Violet"]} />

        </div>
        <div className="one bg-[#8ac249]">
          <SpecificationItem title="Mounting" items={["Recessed", "Surface", "Base Plate", "Pendent"]} />

        </div>
        <div className="one bg-[#8ac249]">
          <SpecificationItem title="IP" items={["IP-20", "IP-40", "IP-43", "IP-50", "IP-65", "IP-67", "IP-68"]} />
      ...
      <div className="top row-span-3 bg-[#ffffff]">
        ...
        <div className="main text-[6px] grid grid-cols-5 grid-rows-6">
          <div className="one row-span-2 p-1 border font-bold">Light Power :</div>
          <div className="one row-span-2 p-1 border font-bold">Adjustable Neck</div>
          <div className="one row-span-2 p-1 border font-bold">Optical Material</div>
          <div className="one row-span-2 p-1 border font-bold">Product Dimension (L/W/H)</div>
          <div className="one row-span-2 p-1 border font-bold">Product Dimension (Cut Off)</div>
          <div className="one row-span-2 p-1 border ">3W</div>
          <div className="one  flex items-center row-span-10 p-1 border ">Tilting</div>
          <div className="one  flex items-center row-span-10 p-1 border ">Reflective Cup+Lens</div>
