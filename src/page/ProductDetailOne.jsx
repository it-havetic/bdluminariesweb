...
//   const getProductsBySeries = async (id) => {
//     try {
//       let res = await axios.get(`/products/series/${id}`);
...
//       getProductsBySeries(selectedSeries[0]._id);
//     }
//   }, []);
...
//       const filteredProducts = data?.filter((item) => (item?.series?._id === seriseID));
