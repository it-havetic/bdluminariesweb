...
//       <div className="flex gap-1 h-[48%]  mt-9">
...
//             {minimalistSeries.map((item) => (
//               <div key={item.id} className="shadow-md rounded bg-[#8ac249] ">
//                 <img src={item.image} className="w-full h-11 object-contain" />
//                 <div className="text-[8px] tracking-widest font-semibold text-center bg-[#1d1d1d] text-white uppercase py-1 rounded-b">
...
//       <div className="flex-1 mt-2 no-scrollbar overflow-x-scroll h-[48%]">
