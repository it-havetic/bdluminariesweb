  ...
  return (
    <div className='h-[100vh] md:p-5  '> 
        <div className='h-[100%] relative  flex flex-col justify-between'>
            ...
            <div className='flex items-center justify-between h-[4%] md:absolute left-0 bottom-0 bg-black md:rounded-b-2xl relative z-30'>
                <Link className='w-[6%] flex justify-center items-center text-[#F15B26]' to='/product/detail/one'><AiOutlineProduct /></Link>
                <marquee scrollamount="5" className='w-[79%] h-full flex items-center  ' behavior="" direction="">
            ...
            <Slider className='boottoom md:h-[100%] h-[48%] relative ' {...settings2}>
                {
