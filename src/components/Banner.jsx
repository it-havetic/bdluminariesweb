  ...
  return (
    <div className="h-[100vh] md:p-5">
      <div className="h-[100%] relative flex flex-col justify-between">
        ...
        <div className="h-[48%] bg-[url(/assets/b12.png)] bg-cover grid grid-cols-5 grid-rows-5 gap-1 relative">
        <div
            className={`one bg-red-400 ${activeIndex >= 1 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
          >
            <p>1</p>
          </div>
          <div
            className={`sixteen bg-rose-400 ${activeIndex >= 16 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
            
          >
            <p>16</p>
          </div>
          <div
            className={`fifteen bg-fuchsia-400 ${activeIndex >= 15 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
            
          >
            <p>15</p>
          </div>
          <div
            className={`fourteen bg-emerald-400 ${activeIndex >= 14 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
            
          >
            <p>14</p>
          </div>
          <div
            className={`thirteen bg-amber-400 ${activeIndex >= 13 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
            
          >
            <p>13</p>
          </div>
          <div
            className={`two bg-blue-400 ${activeIndex >= 2 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
            
          >
            <p>2</p>
          </div>
          <div
            className={`seventeen bg-violet-400 col-span-3 row-span-3 ${activeIndex === 17 ? 'opacity-0' : 'opacity-0'} transition-opacity duration-500`}
            
          >
            <p>17</p>
          </div>
          <div
            className={`twelve bg-lime-400 ${activeIndex >= 12 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
            
          >
            <p>12</p>
          </div>
          <div
            className={`three bg-green-400 ${activeIndex >= 3 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
            
          >
            <p>3</p>
          </div>
          <div
            className={`eleven bg-cyan-400 ${activeIndex >= 11 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
            
          >
            <p>11</p>
          </div>
          <div
            className={`four bg-yellow-400 ${activeIndex >= 4 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
            
          >
            <p>4</p>
          </div>
          <div
            className={`ten bg-gray-400 ${activeIndex >= 10 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
            
          >
            <p>10</p>
          </div>
          <div
            className={`five bg-purple-400 ${activeIndex >= 5 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
            
          >
            <p>5</p>
          </div>
          <div
            className={`six bg-pink-400 ${activeIndex >= 6 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
            
          >
            <p>6</p>
          </div>
          <div
            className={`seven bg-teal-400 ${activeIndex >= 7 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
            
          >
            <p>7</p>
          </div>
          <div
            className={`eight bg-indigo-400 ${activeIndex >= 8 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
            
          >
            <p>8</p>
          </div>
          <div
            className={`nine bg-orange-400 ${activeIndex >= 9 ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
